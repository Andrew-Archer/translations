...
const ruClient = const <String, String> {
  ...
  mShift: "Shift",
  mAlt: "Alt",
  mQuireCannotReach: "Невозможно получить доступ к Quire.",
  mQuireCannotReachDesc: "Пожалуйста, проверьте ваше интернет соединение.",
  mCantMoveInCurrentMode: "Вы не можете перемещать задания пока вы в режиме фильтрации или сортировки.",
  mCantMoveInSortedGroupedMode: "Вы не можете перемещать задания пока вы в режиме фильтрации или группировки.",
  mCantMoveRoot: "Вы не можете перемщать коневую задачу.",
  mCantMoveTask: "Вы не можете переместить [=task].",
  mCantMoveTaskTo: "Вы не можете переместить [=task] here.",
  mCantMoveTaskToPersonalChild: "Вы не можете переместить эту задачу на персональный подуровень.",
  mCantMoveExternalTeamRootTask: "Вы не можете перемещать корневые задания Сторонней Группы.",
  mCantMoveToExternalTeamRootTask: "Вы не можете помещать эту задачу в корневую задачу Сторонней Комманды.",
  mCantMoveToExternalTeamRootTaskP: "Вы не можете помещать эти задачи в корневую задачу Сторонней Комманды..",
  mCantCompleteTask: "У вас не прав для [=task]",
  mCantSetThisState: "Вы не можете устанавливать статус для [=task].",
  mCantDeleteTask: "У вас нет прав чтобы удалять [=task].",
  mCantSetAssignee: "У вас нет прав чтобы назначать исполнителя для [=task].",
  mCantSetAssigneeCross: "Вы не можете назначить [=assignee] для [=task], потомучто [=assignee] из другого проекта.",
  mCantSetAssigneeCrossPlural: "Вы не можете назначить [=assignee] для [=task] и [=count] других задач, потомучто [=assignee] из другого проекта.",
  mCantSetPartner:
    "Вы не можете изменить это для внешней коммандыYou cannot set it to another external team, "
    ", так как [=task] уже кому-то назначена.",
